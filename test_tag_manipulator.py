...
def test_split_string_result_with_spaces_padding():
    # arrange
    stringToSplit = " java"
    regex = ","
    expResult = ["java"]
...
def test_split_string_comma_before_result_one_string():
    # arrange
    stringToSplit = ",java"
    regex = ","
    expResult = ["java"]
...
def test_split_string_comma_after_result_one_string():
    # arrange
    stringToSplit = "java,"
    regex = ","
    expResult = ["java"]
...
def test_split_two_strings_with_spaces_result_two_strings():
    # arrange
